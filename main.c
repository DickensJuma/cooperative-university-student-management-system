...
int main()
{
    ...
    title();
    printf("\n\n\t\t\t\tLab Final Semester Project");
    printf("\n\n\t\t\t\t     The Top Achievers Team");
...
void add(FILE * fp)
{
    ...
    while(another=='y'||another=='Y')
    {
        ...
        printf("\n\n\tEnter marks for the 2 semesters\n");
        for(i=0,avg_grade=0; i<2; i++)
        {
            scanf("%f",&s.marks[i]);
            avg_grade+=s.marks[i];
...
FILE * del(FILE * fp)
{
    ...
    Student s;
    int flag=0,temp_admin_num,siz=sizeof(s);
    FILE *ft;
    ...
    printf("\n\n\tEnter Admission number of Student to Delete the Record");
    printf("\n\n\t\t\tAdmission No. : ");
    scanf("%d",&temp_admin_num);
    ...
    {
        if(s.admission==temp_admin_num)
        {
            flag=1;
            printf("\n\tRecord Deleted for");
            printf("\n\n\t\t%s\n\n\t\t%s\n\n\t\t%d\n\t",s.name,s.dept,s.admission);
            continue;
        }
...
void modify(FILE * fp)
{
    ...
    Student s;
    int i,flag=0,temp_admin_num,siz=sizeof(s);
    float avg_grade;

    printf("\n\n\tEnter admission Number of Student to MODIFY the Record : ");
    scanf("%d",&temp_admin_num);
...
void display(FILE * fp)
{
    ...
    while((fread(&s,siz,1,fp))==1)
    {
        printf("\n\t\tNAME : %s",s.name);
        printf("\n\n\t\tDepertment : %s",s.dept);
        printf("\n\n\t\tAdmission : %d",s.admission);
        printf("\n\n\tMarks: ");

        for(i=0; i<12; i++)
            printf("| %.2f |",s.marks[i]);avg
        printf("\n\n\t\tAverage Grade : %.2f\n\t",s.avg_grade);
        printChar('-',65);
    }
    printf("\n\n\n\t");
